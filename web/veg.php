...
<body>
	...
	if (!empty($product_array)) { 
		...
		<div class="product-item">
			<form method="post" action="cartAction.php?action=addToCart&id=<?php echo $product_array[$key]["id"]; ?>">
			<div class="product-image">
			<img  id="img" height="300" width="300" class="img-responsive zoom-img" src="<?php echo $product_array[$key]["image1"]; ?>"></div>
			<br>
			<div><strong><b><?php echo $product_array[$key]["name"]; ?></strong></div>
			<div><strong>
			
			<?php 
			if($product_array[$key]["category"]=="veg"){?><font color="green">
			<?php echo $product_array[$key]["category"]; ?></font>
			<?php }?>
			<?php 
			if($product_array[$key]["category"]=="non-veg"){?><font color="red">
			<?php echo $product_array[$key]["category"]; ?></font>
			<?php }?>
			...
			<div><input  name="quantity" value="1" size="2" /><br>
