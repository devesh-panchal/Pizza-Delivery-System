<?php
    ...
    $checkEmailExistQry = "SELECT `username` from `login`  where `username` = '".$username."'";// select email exist or no
	...
	$regInsertQry="INSERT INTO `login`(`username`, `password`, `email`) VALUES ('$username','$password','$email')";//insert in to qry db
