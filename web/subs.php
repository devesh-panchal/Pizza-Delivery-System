		...
		<div class="banner-info">
			...
			<?php
				if(isset($_SESSION["username"]))
				{
					...
					<li><a href='edit-order.php'>Cart<span class='glyphicon glyphicon-shopping-cart'></span></a></li>
...
<form action="SendMail/email.php" method="get">
    ...
    <input type="input" placeholder="Email address" name="email" required>
    <label>
      <input type="checkbox" checked="checked" name="subscribe"> Send me vouchers and promo codes 
    </label>
