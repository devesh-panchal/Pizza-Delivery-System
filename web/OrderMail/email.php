...
$res = $db_handle->runQuery($db, "SELECT * from login WHERE "$_SESSION['username']"= "$_SESSION['username'];);
	...
	'allow_self_signed' => true
		...
		$mail->Subject = 'hello'.$res["username"];
		...
		echo 'Message has been sent to '. $res['email'] . '<br/>';
	} catch (Exception $e) {
